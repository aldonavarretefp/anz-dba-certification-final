...
alter pluggable database tvac_modulo_1 save state;

Prompt Creando PDB 2...

create pluggable database tvac_modulo_2
  admin user anz_admin_dnh identified by anz_admin_dnh
  path_prefix = '/opt/oracle/oradata/FREE'
  file_name_convert = ('/pdbseed/', '/tvac_modulo_2/');

Prompt abrir la PDB 2...
alter pluggable database tvac_modulo_2 open;

Prompt guardar el estado de la PDB 2...
alter pluggable database tvac_modulo_2 save state;
