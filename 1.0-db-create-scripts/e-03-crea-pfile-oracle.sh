...
memory_target=768M
control_files=(
    /unam/diplo-bd/proyecto-final/disk/d01/app/oracle/oradata/${ORACLE_SID^^}/control01.ctl,
    /unam/diplo-bd/proyecto-final/disk/d02/app/oracle/oradata/${ORACLE_SID^^}/control02.ctl,
    /unam/diplo-bd/proyecto-final/disk/d03/app/oracle/oradata/${ORACLE_SID^^}/control03.ctl
)
db_domain=fi.unam
